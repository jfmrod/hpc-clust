...
ACLOCAL = ${SHELL} /home/jfmrod/erisdb/work/hpc-clust-1.0.0/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AUTOCONF = ${SHELL} /home/jfmrod/erisdb/work/hpc-clust-1.0.0/missing --run autoconf
AUTOHEADER = ${SHELL} /home/jfmrod/erisdb/work/hpc-clust-1.0.0/missing --run autoheader
AUTOMAKE = ${SHELL} /home/jfmrod/erisdb/work/hpc-clust-1.0.0/missing --run automake-1.11
AWK = gawk
CC = gcc
...
CXXFLAGS = -O3 -pthread -DOS_LINUX -I/usr/local/include -pthread
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
LDFLAGS =  -pthread -L/usr/local/lib -lmpi_cxx -lmpi -lopen-rte -lopen-pal -ldl -Wl,--export-dynamic -lnsl -lutil -lm -ldl
LIBOBJS = 
LIBS = `eutils/eutils-config --libs`
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/jfmrod/erisdb/work/hpc-clust-1.0.0/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
MPICPP = /usr/bin/mpic++
MPI_CFLAGS = 
MPI_LIBS = 
...
STRIP = 
VERSION = 1.0.0
abs_builddir = /home/jfmrod/erisdb/work/hpc-clust-1.0.0
abs_srcdir = /home/jfmrod/erisdb/work/hpc-clust-1.0.0
abs_top_builddir = /home/jfmrod/erisdb/work/hpc-clust-1.0.0
abs_top_srcdir = /home/jfmrod/erisdb/work/hpc-clust-1.0.0
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/jfmrod/erisdb/work/hpc-clust-1.0.0/install-sh
...
hpc-clust-mpi$(EXEEXT): $(hpc_clust_mpi_OBJECTS) $(hpc_clust_mpi_DEPENDENCIES) $(EXTRA_hpc_clust_mpi_DEPENDENCIES) 
