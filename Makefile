...
CXXFLAGS = -O2 -I/home/jfmrod/usr/include -pthread -DOS_LINUX -I/usr/lib/openmpi/include -I/usr/lib/openmpi/include/openmpi -pthread
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
LDFLAGS = -L/home/jfmrod/usr/lib -pthread -L/usr//lib -L/usr/lib/openmpi/lib -lmpi_cxx -lmpi -ldl -lhwloc
LIBOBJS = 
...
PACKAGE_STRING = hpc-clust 1.2.0
...
STRIP = 
VERSION = 1.2.0
abs_builddir = /home/jfmrod/usr/src/hpc-clust
abs_srcdir = /home/jfmrod/usr/src/hpc-clust
abs_top_builddir = /home/jfmrod/usr/src/hpc-clust
abs_top_srcdir = /home/jfmrod/usr/src/hpc-clust
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/jfmrod/install-sh
...
hpc-clust-mpi$(EXEEXT): $(hpc_clust_mpi_OBJECTS) $(hpc_clust_mpi_DEPENDENCIES) $(EXTRA_hpc_clust_mpi_DEPENDENCIES) 
	...
	$(AM_V_CXXLD)$(CXXLINK) $(hpc_clust_mpi_OBJECTS) $(hpc_clust_mpi_LDADD) $(LIBS)
...
recheck: all 
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
tests/single-al.sh.log: tests/single-al.sh
	@p='tests/single-al.sh'; \
	b='tests/single-al.sh'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
	"$$tst" $(AM_TESTS_FD_REDIRECT)
tests/single-sl.sh.log: tests/single-sl.sh
	@p='tests/single-sl.sh'; \
	b='tests/single-sl.sh'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
	"$$tst" $(AM_TESTS_FD_REDIRECT)
tests/mpi-sl.sh.log: tests/mpi-sl.sh
	@p='tests/mpi-sl.sh'; \
	b='tests/mpi-sl.sh'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
