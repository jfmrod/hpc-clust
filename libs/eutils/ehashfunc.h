...
// taken from Bob Jenkins: http://www.burtleburtle.net/bob/hash/doobs.html
inline unsigned int hash_oaat(char* key,int len)
{
  int i;
...
inline uint32_t hash_lookup3( const void *key, size_t length, uint32_t initval)
{
...
// SuperFastHash from Paul Hsieh (http://www.azillionmonkeys.com/qed/hash.html)
...
inline uint32_t hash_sf (const char * data, int len) {
